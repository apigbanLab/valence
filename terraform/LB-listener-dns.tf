...
resource "oci_network_load_balancer_listener" "k3sserver-ILB_Listener_UDP8472" {
  default_backend_set_name = oci_network_load_balancer_backend_set.k3sserver-ILB-BackendSet_UDP8472.name
  network_load_balancer_id = oci_network_load_balancer_network_load_balancer.k3sserver-ILB.id
