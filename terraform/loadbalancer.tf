...
resource "oci_network_load_balancer_listener" "k3sserver-ILB_Listener_6443" {
  ...
  network_load_balancer_id         = oci_load_balancer_load_balancer.k3sserver-ILB.id
...
resource "oci_network_load_balancer_listener" "k3sagent-ILB_Listener_443" {
  ...
  network_load_balancer_id         = oci_load_balancer_load_balancer.k3sagent-ILB.id
...
resource "oci_network_load_balancer_listener" "k3sdb-ILB_Listener_5432" {
  ...
  network_load_balancer_id         = oci_load_balancer_load_balancer.k3sdb-ILB.id
